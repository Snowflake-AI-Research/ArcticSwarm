...
class ContextManagementMixin:
    ...
    def _compact_context_structured(self) -> bool:
        ...
        # 0628 selective-delete: prune certainly-wrong tool-result paths from the
    ...
    # frees budget for real findings (0628 selective-delete).
    ...
    def _call_compaction_llm(self, messages: list[dict[str, Any]]) -> str | None:
        ...
        # compaction doesn't reuse the failing primary.  See
        # ``docs/analysis-gpt5.4-failure/06_hypothesis_fallback_degradation.md``
        # Fix C: when GPT-5.4 emits empty primary responses, it also emits
