...
class PrepareReportTool(BaseTool):
    ...
    def __init__(
        ...
        # 0628 answer-retention: append a deterministic BBS candidate digest to
    ...
    def _build_candidate_digest(self) -> str:
        """0628 answer-retention: deterministic BBS candidate digest.
...
class SendReportTool(BaseTool):
    ...
    def __init__(
        ...
        *,
        ...
        # /testbed diff to exist, then apply+test+interpret), so
        ...
        # 0629 anti-give-up + canonical-answer (qwen-gated via reject_refusal):
    ...
    def execute(self, **kwargs: Any) -> ToolResult:
                ...
                if waited < self._reviewer_stall_budget_s:
                    ...
                    return ToolResult(
                        error=(
                            ...
                            f"you: they pull your /testbed diff, "
                            f"replay it in a scratch worktree, run "
                            f"pytest, and write structured findings. "
        ...
        # 0629 anti-give-up bounce (qwen-gated). If the FINAL ANSWER is a
