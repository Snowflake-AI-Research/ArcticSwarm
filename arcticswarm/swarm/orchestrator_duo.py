...
class DuoMixin:
    ...
    def _run_duo_turn(
        ...
        *,
        ...
        # implementation and the duo race audit at
        # ``/tmp/audit_duo_conflicts.py`` for the motivation: 76% of duo
        # second-comer edits operate from a stale view and 70% of
        # overlapping edits happen with zero comm between the two agents.
