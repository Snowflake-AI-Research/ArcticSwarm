...
def _make_peer_tool_observer(
    *,
    ...
    See SwarmConfig.peer_tool_observation in run_config.py for rationale and
    the duo race audit (`/tmp/audit_duo_conflicts.py`) that motivated this.
    """
...
class SwarmOrchestrator(DmMixin, DuoMixin):
    ...
    def _export_bbs(self, bbs: BBS | None) -> None:
        ...
        export_dir = Path.home() / ".snowflake" / "arcticswarm" / "bbs"
        try:
