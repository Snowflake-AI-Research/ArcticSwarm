    ...
    def _fallback_on_empty_response(
        ...
        *,
        ...
        if self.config.reasoning_effort:
            ...
            # think-only turn that just emptied (measured: reasoning=high
            # recovered 0/996 empties on Tongyi-DeepResearch, while the
        ...
        for spec in fallback_specs:
            ...
            try:
                ...
                # missing — saves ~50% of fallback latency per case on
